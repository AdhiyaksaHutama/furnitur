...
<body>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="sku" name="sku" value="MJ-" readonly>
        <select class="form-control" id="category" name="category" onchange="updateSku()">
  ...
  <!-- Gambar -->
    <div class="form-group">
        ...
        <input id="filenames" type="file" class="form-control" name="filenames[]" multiple required>
    </div>
    <!-- Category -->
    <div class="form-group">
